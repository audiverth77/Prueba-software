...
class OrderController extends Controller
{
    ...
    {
        $order = DB::select('SELECT o.id, o.name as or_name, p.name as pro_name, o.product_quantity, o.date FROM orders as o, products as p WHERE o.id_products = p.id');
        ...
        if($request){
            $order = DB::select('SELECT o.id, o.name as or_name, p.name as pro_name, o.product_quantity, o.date 
                                    ...
                                    AND o.date = ', ['date' => $request->input('date')]);
            $size_array = sizeof($order);
        }
